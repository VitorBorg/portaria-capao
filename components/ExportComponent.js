      ...
      <div class="flex flex-wrap -mx-4">
         <div class="w-full">
            <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
               ...
               <button class="sm:w-full lg:w-auto my-2 border rounded md py-4 px-8 text-center bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">Saber mais sobre backup</button>
            </div>
         </div>
      </div>
