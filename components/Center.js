      ...
      <div className="flex flex-wrap justify-center -mx-4">
         ...
         <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <span className="text-base text-body-color">
                 O sistema foi feito com a framework node.js utilizando React para o front-end e Tailwind para o estilo, Next.js para o back-end, Next auth para autenticação, mongoose para schema model, e para o banco usa-se o gerenciador MONGO-DB. <br/> O email cadastrado no mongo é o email da portaria.
               </span>
